...
//YOUR CODE HERE
const repeatMyParam = () => {
    axios.get('http://localhost:3000/repeat/yourParam')
        .then((res) => {
...
const sendQueryRequest = () => {
    axios.get('http://localhost:3000/query-test?query=example')
        .then((res) => {
            console.log(res.data)
        })
}
document.getElementById('query-button').addEventListener('click', sendQueryRequest);
